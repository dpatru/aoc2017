...
while unfinished:
    ...
    if final:
        ...
        if len(seq) > len(longestseq) or (len(seq) == len(longestseq) and val > longestval):
            longestseq = seq
            longestval = val
            print(len(unfinished),'unfinished, longest', longestval, longestseq, orderSeq(longestseq))
